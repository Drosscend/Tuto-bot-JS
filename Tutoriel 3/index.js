...
client.on("guildMemberAdd", async member => { // Voici le nom de l'event
    ...
    let channeldebienvenue = member.guild.channels.get("611577136758784049"); // A la place de "611577136758784049" vous pouvez mettre l'611577136758784049 ou vous souhaitez que le bot envoie le message.
...
client.on("guildMemberRemove", async member => { // Voici le nom de l'event
    ...
    let channeldeadieu = member.guild.channels.get("611577136758784049"); // A la place de "611577136758784049" vous pouvez mettre l'611577136758784049 ou vous souhaitez que le bot envoie le message.
...
client.on('messageUpdate', (oldMessage, newMessage) => { // Voici le nom de l'event
    ...
    var Channeldelogs = guild.channels.get("611577136758784049");  // A la place de "611577136758784049" vous pouvez mettre l'611577136758784049 ou vous souhaitez que le bot envoie le message.
...
client.on("messageDelete", (message) => { // Voici le nom de l'event
    ...
    var Channeldelogs = message.guild.channels.get("611577136758784049"); // A la place de "611577136758784049" vous pouvez mettre l'611577136758784049 ou vous souhaitez que le bot envoie le message.
